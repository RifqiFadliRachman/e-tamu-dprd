...
<div class="bg-white shadow rounded-lg overflow-hidden">
    ...
    <table class="w-full border-collapse text-center">
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-[#FFF5E5]">
                ...
                <td class="px-4 py-2">George Frederik</td>
                <td class="px-4 py-2">0823828232</td>
                <td class="px-4 py-2">Kunjungan Tamu</td>
    ...
    <!-- Pagination -->
    <div class="flex justify-end items-center p-4 text-[#C4963C]">
        <button class="px-3 py-1 border rounded-l hover:bg-[#C4963C] hover:text-white">←</button>
        <span class="px-4 py-1 border-t border-b">1</span>
        <button class="px-3 py-1 border rounded-r hover:bg-[#C4963C] hover:text-white">→</button>
    </div>
</div>

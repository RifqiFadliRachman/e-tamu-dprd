                ...
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="relative w-1/3">
                            ...
                            <!-- Input -->
                            <input type="text" placeholder="Cari nama admin" class="w-full pl-12 pr-4 py-2 border border-gray-300 rounded-full 
                           focus:outline-none focus:ring-1 focus:ring-[#E8BF6F]/50 
                           focus:border-[#E8BF6F] placeholder-gray-400 text-gray-700">
                        </div>

                        <!-- Tombol Tambah Pengguna -->
                        <button class="bg-[#E8BF6F] text-white font-semibold px-6 py-2 rounded-full hover:opacity-90">
                            Tambah Pengguna
                        </button>
                    </div>
                                ...
                                <div class="grid grid-cols-3 items-center p-3 hover:bg-[#FFF8E7]">
                                    ...
                                    <div class="flex items-center gap-3 justify-end">
                                        ...
                                        <button class="text-gray-700 hover:text-black">
                                            <svg width="30" height="30" viewBox="0 0 36 35" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <rect width="36" height="35" fill="#3E9E66" />
                                                <path d="M26 16.8V26H10V10H19.2L21.2 8H8V28H28V14.8L26 16.8Z"
                                                    fill="white" />
                                                <path
                                                    d="M20.5 18.3L17 19L17.7 15.5L27.6 5.6C28.4 4.8 29.6 4.8 30.4 5.6C31.2 6.4 31.2 7.6 30.4 8.4L20.5 18.3Z"
                    ...
                    <!-- Pagination -->
                    <div class="flex justify-end mt-6 items-center gap-2 text-sm text-gray-600">

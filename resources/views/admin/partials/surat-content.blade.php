                ...
                <div class="flex items-center gap-4">
                    ...
                    @if ($tamu->surat_permohonan_path)
                        <div class="text-center">
                            ...
                            <div class="flex gap-2 mt-1 justify-center">
                                <a href="{{ asset('storage/' . str_replace('public/', '', $tamu->surat_permohonan_path)) }}" target="_blank" class="p-1 rounded hover:opacity-80" title="Lihat Surat">
                                ...
                                <button onclick="printSurat('{{ asset('storage/' . str_replace('public/', '', $tamu->surat_permohonan_path)) }}')" class="p-1 rounded hover:opacity-80" title="Cetak Surat">
                    ...
                    @if ($tamu->surat_tugas_path)
                        <div class="text-center">
                            ...
                            <div class="flex gap-2 mt-1 justify-center">
                                <a href="{{ asset('storage/' . str_replace('public/', '', $tamu->surat_tugas_path)) }}" target="_blank" class="p-1 rounded hover:opacity-90 flex items-center justify-center" title="Lihat Surat">
                                ...
                                <button onclick="printSurat('{{ asset('storage/' . str_replace('public/', '', $tamu->surat_tugas_path)) }}')" class="p-1 rounded hover:opacity-90 flex items-center justify-center" title="Cetak Surat">

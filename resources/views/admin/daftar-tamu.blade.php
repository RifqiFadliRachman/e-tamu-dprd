...
<tbody class="divide-y divide-gray-200">
    ...
    <tr class="hover:bg-[#FFF4E0] transition-colors duration-200">
        ...
        <td class="px-4 py-2 text-sm text-gray-900">{{ $tamu->jenis_kunjungan }}</td>

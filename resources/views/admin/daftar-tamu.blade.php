            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div class="py-4 mt-4">
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Cari nama tamu" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-gold/50">
                    </div>
                </div>

                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left">
                        <thead class="text-gray-600 font-bold uppercase">
                            <tr>

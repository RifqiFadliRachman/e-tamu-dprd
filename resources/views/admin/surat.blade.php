...
<main class="flex-1 p-6">
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-300">
        ...
        <div class="grid grid-cols-3 text-sm font-semibold text-[#E8BF6F] mb-2">
            ...
            <span class="text-right pr-4">Aksi</span>
        </div>

        <!-- Table Content -->
        <div class="border rounded-md">
            @for($i = 0; $i < 3; $i++)
            <div class="grid grid-cols-3 items-center p-3 hover:bg-[#FFF8E7] {{ $i < 2 ? 'border-b border-gray-300' : '' }}">
                <!-- Perihal Surat -->
                ...
                <div class="flex justify-end gap-2">
                    <button class="p-2 rounded bg-blue-500 hover:opacity-80">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10 3a7 7 0 00-7 7 7 7 0 0014 0 7 7 0 00-7-7zm0 3a4 4 0 110 8 4 4 0 010-8z" />
                        </svg>
                    </button>
